    ...
    <header>
        ...
        <div class="container-menu-desktop">
            ...
            <div class="wrap-logo container">
				...
				<div class="banner-header">
					<a href="{{ $banner->link ?? '#' }}">
						<img src="{{ asset('/uploads/banners/' . $banner->image) }}" alt="Banner Image" height="90" width="780">
					</a>
				</div>
			@else
				<div class="banner-header">
					<img src="{{ asset('images/place_your_ad.jpg') }}" alt="Placeholder Ad" height="90" width="780">
				</div>
			@endif
